...
/*
 * Classe TelechargementParalleleUml : Génère la fenêtre JFrame destinée au TéléchargementParallèle.
 * 
 */

public class TelechargementParalleleUml extends JFrame implements ActionListener {
	...
	public TelechargementParalleleUml(ClientControle cc) {
		this.cc=cc;
