...
/*
 * Classe UmlRechercheAuteur : Génère la fenêtre JFrame permettant la recherche par date
 * 
 */

public class UmlRechercheDate implements ActionListener {
	/*
