...
/*
 * Classe TelechargementSimpleUml : Génère la fenêtre JFrame destinée au TéléchargementSimple.
 * 
 */

public class TelechargementSimpleUml extends JFrame implements ActionListener {
	/*
	...
	public TelechargementSimpleUml(ClientControle cc) {
