...
/*
 * Classe Uml : Génère la fenêtre JFrame destinée aux fonctionnalités du projet.
 * 
 */
public class Uml extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource() == bt1) {
			...
			TelechargementSimpleUml tsu = new TelechargementSimpleUml(this.controle);
		}
		...
		if(arg0.getSource() == bt2) {
			...
			if(gjt.length()!=0) {
				...
				TelechargementParalleleUml tpu = new TelechargementParalleleUml(this.controle);
