...
/*
 * Classe UmlRechercheAuteur : Génère la fenêtre JFrame permettant la recherche par nom
 * 
 */

public class UmlRechercheNom implements ActionListener {
	/*
	...
	public UmlRechercheNom(ClientControle cc) {
		this.cc=cc;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button) {
			...
			if(textArea1.getText().length()!=0) {
				...
				GestionFichier gf = new GestionFichier(PreUml.getJTextField1()+PreUml.getJTextField2());
