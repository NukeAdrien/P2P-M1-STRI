...
/*
 * Classe UmlGF : Génère la fenêtre JFrame destinée à la fonctionnalité gestion de fichiers 
 * 
 */
public class UmlGF extends JFrame implements ActionListener {
	...
	public UmlGF(ClientControle cc) {
		this.cc=cc;
